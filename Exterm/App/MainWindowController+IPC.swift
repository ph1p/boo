...
extension MainWindowController {
    ...
    func setupIPCHandlers() {
        ...
        ExtermSocketServer.shared.onControlCommand = { [weak self] cmd, json, reply in
        ...
        ExtermSocketServer.shared.onExternalSegmentsChanged = { [weak self] segments in
    ...
    private func updateExternalStatusBarSegments(
        _ segments: [ExtermSocketServer.ExternalSegmentInfo]
    ) {
