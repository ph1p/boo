...
@MainActor
private final class CwdOnlyPlugin: BooPluginProtocol {
...
@MainActor
private final class NoEventsPlugin: BooPluginProtocol {
    let manifest = PluginManifest(
...
@MainActor
private final class AllEventsPlugin: BooPluginProtocol {
    let manifest = PluginManifest(
...
@MainActor
private final class ProcessAndRemotePlugin: BooPluginProtocol {
    let manifest = PluginManifest(
...
final class PluginSubscriptionTests: XCTestCase {
    ...
    func testBuiltinPluginSubscriptions() {
        ...
        let aiAgent = registry.plugin(for: "agents")!
