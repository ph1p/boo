...
final class PluginRuntime {
    private(set) var plugins: [BooPlugin] = []
    private let logger = Logger(subsystem: "com.boo", category: "PluginRuntime")

    /// The most recent frozen context after a cycle completes.
    private(set) var lastContext: TerminalContext?

    func register(_ plugin: BooPlugin) {
